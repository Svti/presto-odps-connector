...
public class OdpsConnector implements Connector {
	...
	@Inject
	public OdpsConnector(LifeCycleManager lifeCycleManager, OdpsMetadata metadata, OdpsSplitManager splitManager,
			OdpsRecordSetProvider recordSetProvider, OdpsPageSinkProvider pageSinkProvider) {
