...
public class OdpsRecordCursor implements RecordCursor {
	...
	public OdpsRecordCursor(InputSplit odpsInputSplit, List<OdpsColumnHandle> columnHandles,
			SplitReader<ArrayRecord> recordReader, boolean isZeroColumn) {
